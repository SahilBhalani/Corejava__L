	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu"><a href="index">Home</a>
								<ul class="sub-menu">
							...
							<li class="label1" data-label1="hot"><a href="shoping-cart">Cart</a>
							</li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li><a href="shoping-cart" class="label1 rs1" data-label1="hot">Cart</a>
				</li>
						...
						<img src="images/banner-03.jpg" alt="IMG-BANNER"> <a
							...
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									${c.getCategoryname()} </span> <span class="block1-info stext-102 trans-04">
									New Trend </span>
							</div>
		...
		<div class="container">
			...
			<c:forEach var="c" items="${categories}">
					...
					<button
						...
						data-filter="*">${c.getCategoryname()}</button>
